!(function (a) {
  ...
  a(document).ready(function () {
    var a,
      ...
      f = [
        [
          '<div class="infobox"><span>Sanmour Architects & Consultants<span></br><span>Email: info@sanmour.in</span></div>',
          c,
          d,
          2,
        ],
      ],
      g = new google.maps.Map(document.getElementById("map-canvas"), {
        zoom: e,
        scrollwheel: !1,
        navigationControl: !0,
        mapTypeControl: !1,
    ...
    for (b = 0; b < f.length; b++)
      (a = new google.maps.Marker({
        position: new google.maps.LatLng(f[b][1], f[b][2]),
        map: g,
    ...
    !(function (a) {
      a.fn.downCount = function (b, c) {
        function d() {
          ...
          var q = 1 === m ? "day" : "days",
            r = 1 === n ? "hour" : "hours",
            s = 1 === o ? "minute" : "minutes",
            t = 1 === p ? "second" : "seconds";
          f.find(".days").text(m),
            f.find(".hours").text(n),
      ...
      (function (a) {
        a(".countdown").downCount(
          { date: "12/30/2016 12:00:00", offset: 10 },
          function () {
  ...
  jQuery(document).ready(function (a) {
    a(".counter").counterUp({ delay: 100, time: 3e3 });
  }),
  (function (a) {
    "use strict";
    var b = a(".list-portfolio-warp").imagesLoaded(function () {
      b.isotope({
    ...
    a(".projectFilter a").click(function () {
      a(".projectFilter .current").removeClass("current"),
      ...
      return this.each(function () {
        var b = a(this),
          ...
          e = function () {
            ...
            e = e.replace(/,/g, "");
            for (
              var g = (/^[0-9]+$/.test(e), /^[0-9]+\.[0-9]+$/.test(e)),
                h = g ? (e.split(".")[1] || []).length : 0,
                i = c;
              i >= 1;
              i--
            ) {
            ...
            var k = function () {
              b.text(b.data("counterup-nums").shift()),
                b.data("counterup-nums").length
                  ? setTimeout(b.data("counterup-func"), d.delay)
                  : (delete b.data("counterup-nums"),
                    b.data("counterup-nums", null),
                    b.data("counterup-func", null));
            };
            b.data("counterup-func", k),
              setTimeout(b.data("counterup-func"), d.delay);
          };
      ...
      (a[c] = function (a, b, c) {
        ...
        (a[c].prototype = {
          ...
          openPanel: function (b) {
            ...
            if (d.hasClass(e.vertical)) {
              ...
              d.addClass(e.opened),
                ...
                this.trigger("openingPanel", b),
                this.trigger("openedPanel", b);
            } else {
              if (b.hasClass(e.current)) return;
              var h = this.$pnls.children("." + e.panel),
                i = h.filter("." + e.current);
              h
                .removeClass(e.highest)
                .removeClass(e.current)
                .not(b)
                .not(i)
                .not("." + e.vertical)
                .addClass(e.hidden),
                a[c].support.csstransitions || i.addClass(e.hidden),
                b.hasClass(e.opened)
                  ? b
                      .nextAll("." + e.opened)
                      .addClass(e.highest)
                      .removeClass(e.opened)
                      .removeClass(e.subopened)
                  : (b.addClass(e.highest), i.addClass(e.subopened)),
                b.removeClass(e.hidden).addClass(e.current),
                f.trigger("openPanel", b),
                setTimeout(function () {
                  b.removeClass(e.subopened).addClass(e.opened),
                    f.trigger("openingPanel", b),
                    f.__transitionend(
                      b,
                      function () {
          ...
          closePanel: function (a) {
            var b = a.parent();
            b.hasClass(e.vertical) &&
              (b.removeClass(e.opened),
              this.trigger("closePanel", a),
              this.trigger("closingPanel", a),
              this.trigger("closedPanel", a));
          },
          ...
          togglePanel: function (a) {
            var b = a.parent();
            b.hasClass(e.vertical) &&
              this[b.hasClass(e.opened) ? "closePanel" : "openPanel"](a);
          },
          ...
          trigger: function () {
            var a = this,
              ...
              c = b.shift();
            if (this.cbck[c])
              for (var d = 0, e = this.cbck[c].length; e > d; d++)
          ...
          _initMenu: function () {
            this.$menu.attr(
              ...
              (this.$pnls = a('<div class="' + e.panels + '" />')
                .append(this.$menu.children(this.conf.panelNodetype))
                .prependTo(this.$menu)),
              this.$menu.parent().addClass(e.wrapper);
            var b = [e.menu];
            this.opts.slidingSubmenus || b.push(e.vertical),
          ...
          _initPanels: function (b) {
            ...
            this.__refactorClass(
              ...
              "inset"
            ).addClass(e.nolistview + " " + e.nopanel),
              d.not("." + e.nolistview).addClass(e.listview);
            ...
            this.__refactorClass(g, this.conf.classNames.selected, "selected"),
              ...
              this.__refactorClass(
                this.__findAddBack(b, "." + this.conf.classNames.panel),
            ...
            var h = a(),
              i = b
                .add(b.find("." + e.panel))
                .add(
                  this.__findAddBack(b, "." + e.listview)
                    .children()
                    .children(this.conf.panelNodetype)
                )
                .not("." + e.nopanel);
            this.__refactorClass(i, this.conf.classNames.vertical, "vertical"),
              this.opts.slidingSubmenus || i.addClass(e.vertical),
              i.each(function () {
                var b = a(this),
                  d = b;
                b.is("ul, ol")
                  ? (b.wrap('<div class="' + e.panel + '" />'),
                    (d = b.parent()))
                  : d.addClass(e.panel);
                var f = b.attr("id");
                b.removeAttr("id"),
                  d.attr("id", f || c.__getUniqueId()),
                  b.hasClass(e.vertical) &&
                    (b.removeClass(c.conf.classNames.vertical),
                    d.add(d.parent()).addClass(e.vertical)),
                  (h = h.add(d));
              });
            ...
            h.each(function (b) {
              ...
              if (
                (i.is("." + e.panels) ||
                  (i.data(f.sub, h), h.data(f.parent, i)),
                i.children("." + e.next).length ||
                  (i.parent().is("." + e.listview) &&
                    ((d = h.attr("id")),
                    (g = a(
                      '<a class="' +
                        e.next +
                    ...
                    j.is("span") && g.addClass(e.fullsubopen))),
                !h.children("." + e.navbar).length && !i.hasClass(e.vertical))
              ) {
                i.parent().is("." + e.listview)
                  ? (i = i.closest("." + e.panel))
                  : ((j = i
                      .closest("." + e.panel)
                      .find('a[href="#' + h.attr("id") + '"]')
                      .first()),
                    (i = j.closest("." + e.panel)));
                var k = !1,
            ...
            var k = this.__findAddBack(b, "." + e.listview)
              .children("." + e.selected)
              .removeClass(e.selected)
              .last()
              .addClass(e.selected);
            k
              .add(k.parentsUntil("." + e.menu, "li"))
              .filter("." + e.vertical)
              .addClass(e.opened)
              .end()
              .each(function () {
                a(this)
                  .parentsUntil("." + e.menu, "." + e.panel)
                  .not("." + e.vertical)
                  .first()
                  .addClass(e.opened)
                  .parentsUntil("." + e.menu, "." + e.panel)
            ...
            return (
              l.length || (l = h.first()),
              l.addClass(e.opened).last().addClass(e.current),
              h
                .not("." + e.vertical)
                .not(l.last())
                .addClass(e.hidden)
          ...
          _initAnchors: function () {
            ...
            h.$body.on(g.click + "-oncanvas", "a[href]", function (d) {
              ...
              var j = f.attr("href");
              if (!g && h && j.length > 1 && "#" == j.slice(0, 1))
                try {
                  var k = a(j, b.$menu);
                  k.is("." + e.panel) &&
                    ((g = !0),
                    b[
                      f.parent().hasClass(e.vertical)
                        ? "togglePanel"
                        : "openPanel"
                    ](k));
                } catch (l) {}
              if (
                ...
                !g &&
                  h &&
                  f.is("." + e.listview + " > li > a") &&
                  !f.is('[rel="external"]') &&
                  !f.is('[target="_blank"]'))
              ) {
                b.__valueOrFn(b.opts.onClick.setSelected, f) &&
                  b.setSelected(a(d.target).parent());
                var m = b.__valueOrFn(
                  b.opts.onClick.preventDefault,
                  f,
                  "#" == j.slice(0, 1)
                );
                m && d.preventDefault(),
                  b.__valueOrFn(b.opts.onClick.close, f, m) && b.close();
              }
            });
          },
          _initAddons: function () {
            var b;
            for (b in a[c].addons)
              a[c].addons[b].add.call(this),
                (a[c].addons[b].add = function () {});
          ...
          __valueOrFn: function (a, b, c) {
            return "function" == typeof a
              ? a.call(b[0])
              : "undefined" == typeof a && "undefined" != typeof c
              ? c
              : a;
          },
          ...
          __transitionend: function (a, b, c) {
            ...
            a.one(g.transitionend, e),
              a.one(g.webkitTransitionEnd, e),
              setTimeout(e, 1.1 * c);
          },
        ...
        (a.fn[c] = function (d, e) {
          return (
            ...
            (e = a.extend(!0, {}, a[c].configuration, e)),
            this.each(function () {
              var b = a(this);
              if (!b.data(c)) {
                var f = new a[c](b, d, e);
  ...
  (function (a) {
    ...
    (a[b].addons[c] = {
        ...
        if (this.opts[c]) {
          ...
          (g = a[b].glbl),
            ...
            ("top" == e.position || "bottom" == e.position) &&
              (e.zposition = "front"),
            "string" != typeof f.pageSelector &&
              (f.pageSelector = "> " + f.pageNodetype),
            (g.$allMenus = (g.$allMenus || a()).add(this.$menu)),
            (this.vars.opened = !1);
          var h = [d.offcanvas];
          "left" != e.position && h.push(d.mm(e.position)),
            "back" != e.zposition && h.push(d.mm(e.zposition)),
            this.$menu.addClass(h.join(" ")).parent().removeClass(d.wrapper),
            this.setPage(g.$page),
            this._initBlocker(),
            this["_initWindow_" + c](),
      ...
      clickAnchor: function (a, b) {
        ...
        return d && a.is('[href="#' + d + '"]')
          ? (this.open(), !0)
          : g.$page
          ? ((d = g.$page.first().attr("id")),
            d && a.is('[href="#' + d + '"]') ? (this.close(), !0) : !1)
          : void 0;
      },
    }),
      (a[b].defaults[c] = {
      ...
      (a[b].prototype._openSetup = function () {
        var b = this,
          h = this.opts[c];
        this.closeAllOthers(),
          g.$page.each(function () {
            a(this).data(e.style, a(this).attr("style") || "");
          }),
          g.$wndw.trigger(f.resize + "-" + c, [!0]);
        var i = [d.opened];
        h.blockUI && i.push(d.blocking),
          "modal" == h.blockUI && i.push(d.modal),
          h.moveBackground && i.push(d.background),
          "left" != h.position && i.push(d.mm(this.opts[c].position)),
          "back" != h.zposition && i.push(d.mm(this.opts[c].zposition)),
          this.opts.extensions && i.push(this.opts.extensions),
          g.$html.addClass(i.join(" ")),
          setTimeout(function () {
            b.vars.opened = !0;
          }, this.conf.openingInterval),
          this.$menu.addClass(d.current + " " + d.opened);
      }),
      ...
      (a[b].prototype.close = function () {
        if (this.vars.opened) {
          ...
          this.__transitionend(
            g.$page.first(),
            function () {
              b.$menu.removeClass(d.current).removeClass(d.opened),
                g.$html
                  .removeClass(d.opened)
                  .removeClass(d.blocking)
                  .removeClass(d.modal)
                  .removeClass(d.background)
                  .removeClass(d.mm(b.opts[c].position))
                  .removeClass(d.mm(b.opts[c].zposition)),
                b.opts.extensions && g.$html.removeClass(b.opts.extensions),
                g.$page.each(function () {
      ...
      (a[b].prototype.setPage = function (b) {
        var e = this,
          f = this.conf[c];
        (b && b.length) ||
          ((b = g.$body.find(f.pageSelector)),
          f.noPageSelector.length && (b = b.not(f.noPageSelector.join(", "))),
          b.length > 1 &&
            f.wrapPageIfNeeded &&
            (b = b.wrapAll("<" + this.conf[c].pageNodetype + " />").parent())),
          b.each(function () {
            a(this).attr("id", a(this).attr("id") || e.__getUniqueId());
          }),
          b.addClass(d.page + " " + d.slideout),
          (g.$page = b),
          this.trigger("setPage", b);
      }),
      (a[b].prototype["_initWindow_" + c] = function () {
        g.$wndw.off(f.keydown + "-" + c).on(f.keydown + "-" + c, function (a) {
          return g.$html.hasClass(d.opened) && 9 == a.keyCode
            ? (a.preventDefault(), !1)
            : void 0;
        });
        var a = 0;
      ...
      (a[b].prototype._initBlocker = function () {
        ...
        this.opts[c].blockUI &&
          (g.$blck ||
            (g.$blck = a(
              '<div id="' + d.blocker + '" class="' + d.slideout + '" />'
            )),
          g.$blck
            .appendTo(g.$body)
            .off(f.touchstart + "-" + c + " " + f.touchmove + "-" + c)
            .on(
              f.touchstart + "-" + c + " " + f.touchmove + "-" + c,
              function (a) {
                a.preventDefault(),
                  a.stopPropagation(),
                  g.$blck.trigger(f.mousedown + "-" + c);
              }
            )
            .off(f.mousedown + "-" + c)
            .on(f.mousedown + "-" + c, function (a) {
              a.preventDefault(),
                g.$html.hasClass(d.modal) || (b.closeAllOthers(), b.close());
            }));
      });
    var d, e, f, g;
  })(jQuery),
      ...
      setup: function () {
        ...
        if (
          ...
          a[b].support.touch &&
            ...
            ("boolean" == typeof h && (h = { fix: h }),
            "object" != typeof h && (h = {}),
            (h = this.opts[c] = a.extend(!0, {}, a[b].defaults[c], h)),
            h.fix))
        ) {
          ...
          this.bind("opening", function () {
            ...
            g.$body
              .on(
                f.touchstart,
                "#" + i + "> ." + d.panels + "> ." + d.current,
                function (a) {
                  e.vars.opened &&
                    (j ||
                      ((j = !0),
                      0 === a.currentTarget.scrollTop
                        ? (a.currentTarget.scrollTop = 1)
                        : a.currentTarget.scrollHeight ===
                            a.currentTarget.scrollTop +
                              a.currentTarget.offsetHeight &&
                          (a.currentTarget.scrollTop -= 1),
                      (j = !1)));
                }
              )
              .on(
                ...
                function (b) {
                  e.vars.opened &&
                    a(this)[0].scrollHeight > a(this).innerHeight() &&
                    b.stopPropagation();
                }
              ),
    ...
    (a[b].addons[c] = {
      setup: function () {
        if (this.opts.offCanvas) {
          ...
          if (
            ...
            "object" != typeof e && (e = {}),
            (e = this.opts[c] = a.extend(!0, {}, a[b].defaults[c], e)),
            ...
            var f = function (b) {
              if (this.vars.opened) {
                var c = parseInt(this.$pnls.css("top"), 10) || 0,
                  ...
                  g = 0;
                this.$menu.addClass(d.measureheight),
                  "auto" == e.height
            ...
            this.bind("opening", f),
              "highest" == e.height && this.bind("init", f),
              "auto" == e.height &&
                (this.bind("update", f),
      ...
      add: function () {
        (d = a[b]._c),
          (e = a[b]._d),
          (f = a[b]._e),
          d.add("autoheight measureheight"),
          f.add("resize");
      },
      clickAnchor: function (a, b) {},
    }),
    ...
    (a[b].addons[c] = {
      ...
      add: function () {
        return window.history && window.history.pushState
          ? ((d = a[b]._c), (e = a[b]._d), void (f = a[b]._e))
          : void (a[b].addons[c].setup = function () {});
      },
      clickAnchor: function (a, b) {},
    }),
      (a[b].defaults[c] = { close: !1 });
    var d, e, f, g;
  })(jQuery),
  (function (a) {
    var b = "mmenu",
      ...
      setup: function () {
        ...
        if (
          ...
          (e.visible.min = Math.max(1, Math.min(6, e.visible.min))),
            (e.visible.max = Math.max(
              e.visible.min,
              Math.min(6, e.visible.max)
            )),
            this.$menu.addClass(d.columns);
          for (
            var f = this.opts.offCanvas ? this.$menu.add(g.$html) : this.$menu,
              h = [],
              i = 0;
            i <= e.visible.max;
            i++
          ...
          var j = function (a) {
              m.call(this, this.$pnls.children("." + d.current)),
                e.hideNavbars && a.removeClass(d.hasnavbar);
            },
            k = function () {
              var a = this.$pnls
                .children("." + d.panel)
                .filter("." + d.opened).length;
              (a = Math.min(e.visible.max, Math.max(e.visible.min, a))),
                f.removeClass(h).addClass(d.columns + "-" + a);
            },
            l = function () {
          ...
          this.bind("open", k),
            this.bind("close", l),
            this.bind("init", j),
            this.bind("openPanel", m),
            this.bind("openingPanel", k),
            this.bind("openedPanel", k),
            this.opts.offCanvas || k.call(this);
        }
      },
      add: function () {
  ...
  (function (a) {
    ...
    (a[b].addons[c] = {
      setup: function () {
        ...
        this.conf[c],
          (g = a[b].glbl),
          "boolean" == typeof h && (h = { add: h, update: h }),
          "object" != typeof h && (h = {}),
          (h = this.opts[c] = a.extend(!0, {}, a[b].defaults[c], h)),
          this.bind("init", function (b) {
            this.__refactorClass(
              a("em", b),
              this.conf.classNames[c].counter,
              "counter"
            );
          }),
          h.add &&
            this.bind("init", function (b) {
              ...
              c.each(function () {
                ...
                b &&
                  (b.children("em." + d.counter).length ||
                    b.prepend(a('<em class="' + d.counter + '" />')));
              });
            }),
          h.update &&
            this.bind("update", function () {
              this.$pnls.children("." + d.panel).each(function () {
                ...
                if (c) {
                  ...
                  g.length &&
                    ((b = b.children("." + d.listview)),
                    b.length &&
                      g.html(f.__filterListItems(b.children()).length));
                }
              });
            });
      },
      ...
      (a[b].defaults[c] = { add: !1, addTo: "panels", update: !1 }),
      (a[b].configuration.classNames[c] = { counter: "Counter" });
    var d, e, f, g;
  })(jQuery),
  (function (a) {
    var b = "mmenu",
    ...
    (a[b].addons[c] = {
      setup: function () {
        ...
        if (
          (this.conf[c],
          (g = a[b].glbl),
          "boolean" == typeof h && (h = { add: h, fixed: h }),
          "object" != typeof h && (h = {}),
          (h = this.opts[c] = a.extend(!0, {}, a[b].defaults[c], h)),
          this.bind("init", function (b) {
            this.__refactorClass(
              a("li", this.$menu),
              this.conf.classNames[c].collapsed,
              "collapsed"
            );
          }),
          h.add &&
                ...
                c
                  ...
                  .each(function () {
                    ...
                    e.__filterListItems(a(this).children()).each(function () {
                      var c = a
                        .trim(a(this).children("a, span").text())
                        .slice(0, 1)
                        .toLowerCase();
                      c != b &&
                        c.length &&
          ...
          (this.$fixeddivider = a(
            ...
            this.bind("update", i),
            this.bind("init", function (b) {
              b.off(f.scroll + "-dividers " + f.touchmove + "-dividers").on(
                f.scroll + "-dividers " + f.touchmove + "-dividers",
                function (b) {
                  i.call(e, a(this));
                }
              );
      ...
      clickAnchor: function (a, b) {
        if (this.opts[c].collapse && b) {
          ...
          if (e.is("." + d.divider)) {
            ...
            return (
              e.toggleClass(d.opened),
              f[e.hasClass(d.opened) ? "addClass" : "removeClass"](
                d.uncollapsed
              ),
              !0
            );
      ...
      (a[b].configuration.classNames[c] = { collapsed: "Collapsed" });
    var d, e, f, g;
  })(jQuery),
  (function (a) {
    function b(a, b, c) {
    ...
    (a[c].addons[d] = {
      setup: function () {
        if (this.opts.offCanvas) {
          ...
          if (
            ...
            "object" != typeof g && (g = {}),
            (g = this.opts[d] = a.extend(!0, {}, a[c].defaults[d], g)),
            g.open)
          ) {
            var j,
              k,
            ...
            var u = this.__valueOrFn(g.pageNode, this.$menu, h.$page);
            "string" == typeof u && (u = a(u));
            var v = new Hammer(u[0], g.vendors.hammer);
            v.on("panstart", function (a) {
              m(a.center[o.typeLower]),
                (h.$slideOutNodes = n()),
                (q = o.open_dir);
            })
              ...
              .on(o.events, function (a) {
                if (
                  ((j = a["delta" + o.typeUpper]),
                  o.negative && (j = -j),
                  j != s && (q = j >= s ? o.open_dir : o.close_dir),
                  (s = j),
                  s > g.threshold && 1 == p)
                ) {
                  ...
                  (p = 2),
                    f._openSetup(),
                    f.trigger("opening"),
                    h.$html.addClass(e.dragging),
                    (t = b(h.$wndw[r]() * i[r].perc, i[r].min, i[r].max));
                }
                2 == p &&
                  ((k =
                    b(s, 10, t) -
                    ("front" == f.opts.offCanvas.zposition ? t : 0)),
                  o.negative && (k = -k),
                  (l = "translate" + o.typeUpper + "(" + k + "px )"),
                  h.$slideOutNodes.css({
              ...
              .on("panend", function (a) {
                2 == p &&
                  (h.$html.removeClass(e.dragging),
                  h.$slideOutNodes.css("transform", ""),
                  f[q == o.open_dir ? "_openFinish" : "close"]()),
                  (p = 0);
              });
          }
        }
      ...
      add: function () {
        return "function" != typeof Hammer || Hammer.VERSION < 2
          ? void (a[c].addons[d].setup = function () {})
          : ((e = a[c]._c),
            (f = a[c]._d),
            (g = a[c]._e),
            void e.add("dragging"));
    ...
    (a[b].addons[c] = {
      setup: function () {
        if (this.opts.offCanvas) {
          ...
          if (
            ((g = a[b].glbl),
            "boolean" == typeof i && i && (i = { drop: i }),
            "object" != typeof i && (i = {}),
            "string" == typeof i.position && (i.position = { of: i.position }),
            ...
            if ("string" != typeof i.position.of) {
              ...
              k &&
                k.length &&
                (this.conf.clone && (k = d.umm(k)),
                (i.position.of = '[href="#' + k + '"]'));
            }
            if ("string" == typeof i.position.of) {
              var l = a(i.position.of);
              if (l.length) {
                this.$menu.addClass(d.dropdown),
                  i.tip && this.$menu.addClass(d.tip),
                  (i.event = i.event.split(" ")),
                  1 == i.event.length && (i.event[1] = i.event[0]),
                  "hover" == i.event[0] &&
                    l.on(f.mouseenter + "-dropdown", function () {
                      h.open();
                    }),
                  "hover" == i.event[1] &&
                  ...
                  this.bind("opening", function () {
                    this.$menu.data(e.style, this.$menu.attr("style") || ""),
                      g.$html.addClass(d.dropdown);
                  }),
                  this.bind("closed", function () {
                    this.$menu.attr("style", this.$menu.data(e.style)),
                      g.$html.removeClass(d.dropdown);
                  });
                var m = function (e, f) {
                    var h = f[0],
                      k = f[1],
                    ...
                    null === s &&
                      (s = w / 2 > u + (v - u) / 2 ? "after" : "before");
                    var y, z;
                    return (
                      "after" == s
                        ? ((y = "x" == e ? u : v),
                          (z = w - (y + x)),
                          (h[o] = y + j.offset.button[e]),
                          (h[p] = "auto"),
                          k.push(d["x" == e ? "tipleft" : "tiptop"]))
                        : ((y = "x" == e ? v : u),
                          (z = y - x),
                          (h[p] =
                            "calc( 100% - " +
                            ...
                            "px )"),
                          (h[o] = "auto"),
                          k.push(d["x" == e ? "tipright" : "tipbottom"])),
                      (h[r] = Math.min(a[b].configuration[c][q].max, z)),
                      [h, k]
                    );
                  },
                  n = function (a) {
                ...
                this.bind("opening", n),
                  g.$wndw.on(f.resize + "-dropdown", function (a) {
                    n.call(h);
                  }),
                  this.opts.offCanvas.blockUI ||
                    g.$wndw.on(f.scroll + "-dropdown", function (a) {
                      n.call(h);
                    });
              }
            }
      ...
      add: function () {
        (d = a[b]._c),
          (e = a[b]._d),
          (f = a[b]._e),
          d.add("dropdown tip tipleft tipright tiptop tipbottom"),
          f.add("mouseenter mouseleave resize scroll");
      },
      clickAnchor: function (a, b) {},
    }),
      (a[b].defaults[c] = { drop: !1, event: "click", position: {}, tip: !0 }),
      (a[b].configuration[c] = {
    ...
    (a[b].addons[c] = {
      setup: function () {
        if (this.opts.offCanvas) {
          ...
          this.conf[c],
            (g = a[b].glbl),
            (d = this.opts[c] = a.extend(!0, {}, a[b].defaults[c], d));
          var e = function (a) {
            var b = this.conf.classNames[c].fixed;
            this.__refactorClass(a.find("." + b), b, "slideout").appendTo(
              g.$body
            );
          };
      ...
      (a[b].configuration.classNames[c] = { fixed: "Fixed" });
    var d, e, f, g;
  })(jQuery),
  (function (a) {
    var b = "mmenu",
    ...
    (a[b].addons[c] = {
      setup: function () {
        ...
        if (
          ...
          "object" != typeof f && (f = {}),
          (f = this.opts[c] = a.extend(!0, {}, a[b].defaults[c], f)),
          f.visible++,
          f.add)
        ) {
          ...
          this.bind("openPanel", j),
            this.bind("init", function (b) {
              j.call(e, e.$pnls.children("." + d.current)),
                f.hideNavbars && b.removeClass(d.hasnavbar),
                b.not("." + d.vertical).each(function () {
                  a(this).children("." + d.subblocker).length ||
                    a(this).prepend(
                      '<a href="#' +
                        a(this)
                          .closest("." + d.panel)
    ...
    (a[b].addons[c] = {
      setup: function () {
        ...
        if (((g = a[b].glbl), "undefined" != typeof f)) {
          ...
          a.each(f, function (g) {
            var j = f[g];
            "boolean" == typeof j && j && (j = {}),
              "object" != typeof j && (j = {}),
              "undefined" == typeof j.content &&
                (j.content = ["prev", "title"]),
              j.content instanceof Array || (j.content = [j.content]),
              (j = a.extend(!0, {}, e.opts.navbar, j));
            var k = j.position,
              l = j.height;
            "number" != typeof l && (l = 1),
            ...
            for (var n = 0, o = 0, p = j.content.length; p > o; o++) {
              ...
              q
                ? (n += q.call(e, m, j, h))
                : ((q = j.content[o]),
                  q instanceof a || (q = a(j.content[o])),
                  m.append(q));
            }
            (n += Math.ceil(m.children().not("." + d.btn).length / l)),
              n > 1 && m.addClass(d.navbar + "-content-" + n),
              m.children("." + d.btn).length && m.addClass(d.hasbtns),
              m.prependTo(e.$menu);
          });
      ...
      (a[b].configuration[c] = { breadcrumbSeparator: "/" }),
  ...
  (function (a) {
    ...
    a[b].addons[c][d] = function (c, d, e) {
      ...
      this.bind("init", function (b) {
        b.removeClass(f.hasnavbar).each(function () {
          for (
            var b = [],
              c = a(this),
              d = a('<span class="' + f.breadcrumbs + '"></span>'),
              h = a(this).children().first(),
              i = !0;
            h && h.length;
          ...
          d.append(
            b.join(
              '<span class="' +
                f.separator +
                '">' +
                e.breadcrumbSeparator +
                "</span>"
            )
          ).appendTo(c.children("." + f.navbar));
        });
      });
      var i = function () {
        h.html(
      ...
      return this.bind("openPanel", i), this.bind("init", i), 0;
    };
  })(jQuery),
  (function (a) {
    var b = "mmenu",
    ...
    a[b].addons[c][d] = function (c, d) {
      var e = a[b]._c,
        f = a[b].glbl,
        g = a('<a class="' + e.close + " " + e.btn + '" href="#" />').appendTo(
          c
        ),
        h = function (a) {
  ...
  (function (a) {
    ...
    (a[b].addons[c][d] = function (d, e) {
      var f,
        g,
        h = a[b]._c,
        i = a('<a class="' + h.next + " " + h.btn + '" href="#" />').appendTo(
          d
        ),
        j = function (a) {
          ...
          (f = b.attr("href")),
            (g = b.html()),
            i[f ? "attr" : "removeAttr"]("href", f),
            i[f || g ? "removeClass" : "addClass"](h.hidden),
            i.html(g);
        };
      return (
        this.bind("openPanel", j),
  ...
  (function (a) {
    ...
    (a[b].addons[c][d] = function (d, e) {
      var f = a[b]._c,
        g = a('<a class="' + f.prev + " " + f.btn + '" href="#" />').appendTo(
          d
        );
      ...
      var h,
        ...
        j = function (a) {
          if (
            ...
            !a.hasClass(f.vertical))
          ) {
            var b = a.find("." + this.conf.classNames[c].panelPrev);
            b.length || (b = a.children("." + f.navbar).children("." + f.prev)),
              (h = b.attr("href")),
              (i = b.html()),
              g[h ? "attr" : "removeAttr"]("href", h),
              g[h || i ? "removeClass" : "addClass"](f.hidden),
              g.html(i);
          }
        };
      return (
    ...
    (a[b].addons[c][d] = function (d, e) {
      var f,
        ...
        j = function (a) {
          if (
            ((a = a || this.$pnls.children("." + h.current)),
            !a.hasClass(h.vertical))
          ) {
            var b = a.find("." + this.conf.classNames[c].panelTitle);
            b.length ||
              (b = a.children("." + h.navbar).children("." + h.title)),
              (f = b.attr("href")),
              (g = b.html() || e.title),
              i[f ? "attr" : "removeAttr"]("href", f),
              i[f || g ? "removeClass" : "addClass"](h.hidden),
  ...
  (function (a) {
    ...
    (a[d].addons[e] = {
      setup: function () {
        ...
        if (
          ((i = a[d].glbl),
          "boolean" == typeof g && (g = { aria: g, text: g }),
          "object" != typeof g && (g = {}),
          (g = this.opts[e] = a.extend(!0, {}, a[d].defaults[e], g)),
          g.aria)
        ) {
          if (this.opts.offCanvas) {
            var j = function () {
          ...
          var l = function () {
              b(this.$menu.find("." + f.hidden), "hidden", !0),
                b(
                  this.$menu.find('[aria-hidden="true"]').not("." + f.hidden),
                  "hidden",
                  !1
                );
            },
          ...
          this.bind("init", n),
            n.call(this, this.$menu.children("." + f.navbar));
        }
        if (g.text) {
          var o = function (b) {
            b
              .children("." + f.navbar)
              .children("." + f.prev)
              .html(c(h.text.closeSubmenu))
              .end()
              .children("." + f.next)
              .html(c(h.text.openSubmenu))
              .end()
              .children("." + f.close)
              .html(c(h.text.closeMenu)),
              b.is("." + f.panel) &&
                b
                  .find("." + f.listview)
                  .find("." + f.next)
          ...
          this.bind("init", o), o.call(this, this.$menu);
        }
      },
      add: function () {
    ...
    (a[c].addons[d] = {
      setup: function () {
        var i = this,
          ...
          k = this.conf[d];
        (h = a[c].glbl),
          "boolean" == typeof j && (j = { add: j }),
          "object" != typeof j && (j = {}),
          "boolean" == typeof j.resultsPanel &&
            (j.resultsPanel = { add: j.resultsPanel }),
          (j = this.opts[d] = a.extend(!0, {}, a[c].defaults[d], j)),
          (k = this.conf[d] = a.extend(!0, {}, a[c].configuration[d], k)),
            ...
            if (j.add) {
              ...
              if (
                (h.each(function () {
                  ...
                  if (!b.is("." + e.panel) || !b.is("." + e.vertical)) {
                    if (!b.children("." + e.search).length) {
                      ...
                      if (
                        (c &&
                          a(
                            ...
                            .appendTo(l)
                            .on(g.click + "-searchfield", function (a) {
                              a.preventDefault(),
                                m.val("").trigger(g.keyup + "-searchfield");
                            }),
                        d)
                      ) {
                      ...
                      b.hasClass(e.search)
                        ? b.replaceWith(l)
                        : b.prepend(l).addClass(e.hassearch);
                    }
                    if (j.noResults) {
                      var o = b.closest("." + e.panel).length;
                      if (
                        (o || (b = i.$pnls.children("." + e.panel).first()),
                        ...
                        a(
                          ...
                          .append(j.noResults)
                          [p.length ? "insertAfter" : "prependTo"](
                            p.length ? p : b
                          );
                      }
                    }
                    ...
                    ((l = a(
                      ...
                      .append(
                        '<div class="' +
                          ...
                          e.title +
                          '">' +
                          j.resultsPanel.title +
                          "</a></div>"
                      )
                      .append('<ul class="' + e.listview + '" />')
                      .append(
                        this.$pnls
                          .find("." + e.noresultsmsg)
                          .first()
                ...
                this.$menu.find("." + e.search).each(function () {
                  ...
                  m
                    ? ((c = k.closest("." + e.panel)), (h = c))
                    : ((c = a("." + e.panel, i.$menu)), (h = i.$menu)),
                    j.resultsPanel.add && (c = c.not(l));
                    ...
                    u = function () {
                      ...
                      if (b != t) {
                        if (
                          ((t = b),
                          j.resultsPanel.add &&
                            l.children("." + e.listview).empty(),
                          c.scrollTop(0),
                          q
                            .add(p)
                            .addClass(e.hidden)
                            .find("." + e.fullsubopensearch)
                            .removeClass(
                              e.fullsubopen + " " + e.fullsubopensearch
                            ),
                          q.each(function () {
                            var b = a(this),
                              c = r;
                            (j.showTextItems ||
                              (j.showSubPanels && b.find("." + e.next))) &&
                              (c = s);
                            var d =
                              b.data(f.searchtext) || b.children(c).text();
                            d.toLowerCase().indexOf(t) > -1 &&
                              b
                                .add(b.prevAll("." + e.divider).first())
                          ...
                          j.showSubPanels &&
                            c.each(function (b) {
                              var c = a(this);
                              i.__filterListItems(
                                c.find("." + e.listview).children()
                              ).each(function () {
                                var b = a(this),
                                  c = b.data(f.sub);
                                b.removeClass(e.nosubresults),
                                  c &&
                                    c
                                      .find("." + e.listview)
                                      .children()
                          ...
                          if ("" === t)
                            this.closeAllPanels(),
                              this.openPanel(
                                this.$pnls.children("." + e.subopened).last()
                              );
                          else {
                            var d = a();
                            c.each(function () {
                              ...
                              d.find("." + e.next).remove(),
                              l.children("." + e.listview).append(d),
                              this.openPanel(l);
                          }
                        else
                          a(c.get().reverse()).each(function (b) {
                            var c = a(this),
                              d = c.data(f.parent);
                            d &&
                              (i.__filterListItems(
                                ...
                                ? (d.hasClass(e.hidden) &&
                                    d
                                      .children("." + e.next)
                                      .not("." + e.fullsubopen)
                                      .addClass(e.fullsubopen)
                                      .addClass(e.fullsubopensearch),
                                  d
                                    .removeClass(e.hidden)
                                ...
                                : m ||
                                  (c.hasClass(e.opened) &&
                                    setTimeout(function () {
                                      ...
                                      (1.5 * i.conf.openingInterval)),
                                  d.addClass(e.nosubresults)));
                          });
                        h
                          .find("." + e.noresultsmsg)
                          [
                            q.not("." + e.hidden).length
                              ? "addClass"
                              : "removeClass"
                          ](e.hidden),
                          this.update();
                  ...
                  n.off(g.keyup + "-" + d + " " + g.change + "-" + d)
                    .on(g.keyup + "-" + d, function (a) {
      ...
      (a[c].configuration[d] = { clear: !1, form: !1, input: !1, submit: !1 });
    var e, f, g, h;
  })(jQuery),
  (function (a) {
    var b = "mmenu",
      ...
      setup: function () {
        ...
        this.conf[c],
          ...
          this.bind("init", function (b) {
            ...
            if (
              !this.$indexer &&
              this.$pnls.children("." + d.hasindexer).length
            ) {
              (this.$indexer = a('<div class="' + d.indexer + '" />')
                .prependTo(this.$pnls)
                .append(
                    ...
                    function (b) {
                      ...
                      f.scrollTop(0),
                        g
                          ...
                          .each(function () {
                            h === !1 &&
                              c == a(this).text().slice(0, 1).toLowerCase() &&
                              (h = a(this).position().top);
                          }),
                        f.scrollTop(h !== !1 ? h : i);
                    }
                  );
              var g = function (a) {
                e.$menu[
                  (a.hasClass(d.hasindexer) ? "add" : "remove") + "Class"
                ](d.hasindexer);
              };
              this.bind("openPanel", g),
                g.call(this, this.$pnls.children("." + d.current));
            }
          });
      },
      add: function () {
        (d = a[b]._c),
          (e = a[b]._d),
          (f = a[b]._e),
          d.add("indexer hasindexer"),
          f.add("mouseover touchstart");
      },
      clickAnchor: function (a, b) {
        return a.parent().is("." + d.indexer) ? !0 : void 0;
      },
    }),
      (a[b].defaults[c] = { add: !1, addTo: "panels" });
    var d, e, f, g;
  })(jQuery),
  (function (a) {
    var b = "mmenu",
    ...
    (a[b].addons[c] = {
      setup: function () {
        ...
        if (
          ...
          f.hover && this.$menu.addClass(d.hoverselected),
          f.parent)
        ) {
          ...
          var h = function (a) {
            this.$pnls
              ...
              .find("." + d.next)
              .removeClass(d.selected);
            for (var b = a.data(e.parent); b && b.length; )
              b = b
                .children("." + d.next)
                .addClass(d.selected)
                .closest("." + d.panel)
          ...
          this.bind("openedPanel", h),
            this.bind("init", function (a) {
              h.call(this, this.$pnls.children("." + d.current));
            });
        }
      },
      add: function () {
        (d = a[b]._c),
          (e = a[b]._d),
          (f = a[b]._e),
          d.add("hoverselected parentselected");
      },
      clickAnchor: function (a, b) {},
    }),
      (a[b].defaults[c] = { current: !0, hover: !1, parent: !1 });
    var d, e, f, g;
  })(jQuery),
  (function (a) {
    var b = "mmenu",
    ...
    (a[b].addons[c] = {
        ...
        this.opts[c],
          ...
          this.bind("init", function (b) {
            this.__refactorClass(
              ...
              a("input." + d.toggle + ", input." + d.check, b).each(
                function () {
                  var b = a(this),
                    c = b.closest("li"),
                    f = b.hasClass(d.toggle) ? "toggle" : "check",
                    g = b.attr("id") || e.__getUniqueId();
                  c.children('label[for="' + g + '"]').length ||
                    (b.attr("id", g),
                    c.prepend(b),
                    a(
                      '<label for="' + g + '" class="' + d[f] + '"></label>'
      ...
      (a[b].configuration.classNames[c] = { toggle: "Toggle", check: "Check" });
    var d, e, f, g;
  })(jQuery),
  function () {
    var a, b;
            ...
            f = function (c, f, g, i, o, p, q, r) {
              ...
              if (!c.data("sticky_kit")) {
                if (
                  ...
                  (w = d.height()),
                  (y = c.parent()),
                  null != l && (y = y.closest(l)),
                  !y.length)
                )
                  throw "failed to find stick parent";
                if (
                  ((s = u = !1),
                  (C = null != j ? j && c.closest(j) : a("<div />")) &&
                  ...
                  (z = function () {
                    ...
                    return !r &&
                      ...
                      (f = parseInt(y.css("padding-bottom"), 10)),
                      (g = y.offset().top + a + b),
                      (i = y.height()),
                      u &&
                        ((s = u = !1),
                        null == j && (c.insertAfter(C), C.detach()),
                        c
        ...
        for (var f in a) {
          ...
          for (var h in this.waypoints[f]) {
            ...
            n.element !== n.element.window &&
              (q = n.adapter.offset()[g.offsetProp]),
              "function" == typeof o
                ? (o = o.apply(n))
                : "string" == typeof o &&
                  ((o = parseFloat(o)),
                  n.options.offset.indexOf("%") > -1 &&
                    (o = Math.ceil((g.contextDimension * o) / 100))),
  ...
  $(document).ready(function () {
    ...
    var a = $("#testimonial-1").owlCarousel({
      autoPlay: !0,
      items: 1,
      loop: !0,
      dots: !1,
    ...
    $("body").on("click", ".next-testimonial-h1", function (b) {
      a.trigger("next.owl.carousel");
    }),
      $("body").on("click", ".prev-testimonial-h1", function (b) {
...
var Royal_Preloader = {
  ...
  _mode: (function () {
    return "undefined" != typeof Royal_Preloader &&
      "undefined" != typeof Royal_Preloader._mode
      ? Royal_Preloader._mode
      : "number";
  })(),
  _text: (function () {
    return "undefined" != typeof Royal_Preloader &&
      "undefined" != typeof Royal_Preloader._text
      ? Royal_Preloader._text
      : "loading...";
  })(),
  _opacity: (function () {
    return "undefined" != typeof Royal_Preloader &&
      "undefined" != typeof Royal_Preloader._opacity
      ? Royal_Preloader._opacity
      : 1;
  })(),
  _images: (function () {
    return "undefined" != typeof Royal_Preloader &&
      "undefined" != typeof Royal_Preloader._images
      ? Royal_Preloader._images
      : {};
  })(),
  _show_info: (function () {
    return "undefined" != typeof Royal_Preloader &&
      "undefined" != typeof Royal_Preloader._show_info
      ? Royal_Preloader._show_info
      : !0;
  })(),
  _show_percentage: (function () {
    return "undefined" != typeof Royal_Preloader &&
      "undefined" != typeof Royal_Preloader._show_percentage
      ? Royal_Preloader._show_percentage
      : !0;
  })(),
  _background: (function () {
    return "undefined" != typeof Royal_Preloader &&
      "undefined" != typeof Royal_Preloader._background
      ? Royal_Preloader._background
      : ["#000000"];
  })(),
  _logo: (function () {
    return "undefined" != typeof Royal_Preloader &&
      "undefined" != typeof Royal_Preloader._logo
      ? Royal_Preloader._logo
      : "none";
  })(),
  _timeout: 10,
  ...
  _css3SupportDetect: function () {
    ...
    for (
      var b = ["Webkit", "Moz", "Khtml", "O", "ms"], c = 0;
      c < b.length;
      c++
    )
  ...
  _build: function () {
    (this._overlay = $("<div>")
      ...
      .addClass(this._mode)),
      (this._overlay_bg = $("<div>")
        .addClass("background")
        .appendTo(this._overlay)
        .css("background-color", this._background[0])),
      "number" === this._mode
        ? (this._percentage = $("<div>")
            .addClass("percentage")
            .appendTo(this._overlay))
        : "text" === this._mode
        ? ((this._text_loader = $("<div>")
            .addClass("loader")
            .text(this._text)
            .appendTo(this._overlay)),
          (this._text_loader_overlay = $("<div>")
            .css("background-color", this._background[0])
            .appendTo(this._text_loader)))
        : ((this._logo_loader = $("<div>")
            .css("background-image", 'url("' + this._logo + '")')
            .addClass("loader")
            .appendTo(this._overlay)),
          (this._logo_loader_meter = $("<div>")
            .css("background-color", this._background[0])
  ...
  _load: function () {
    ("number" !== this._mode && "logo" !== this._mode) ||
      ...
      $.each(this._images, function (a, b) {
        var c = function () {
          ...
          d = new Image();
        (d.onload = c), (d.onerror = c), (d.src = b);
      }),
      setTimeout(function () {
  ...
  _animatePercentage: function (a, b) {
    (Royal_Preloader._percentage_loaded = a),
      b > a &&
        (a++,
        setTimeout(function () {
          "number" === Royal_Preloader._mode
            ? Royal_Preloader._show_percentage &&
              Royal_Preloader._percentage.text(a + "%")
            : "text" === Royal_Preloader._mode
  ...
  _animateName: function (a, b) {
    if ("number" === this._mode) {
      ...
      requestAnimFrame(function () {
        c.css(
          "transform",
          "rotateZ(" + parseInt(60 * Math.random() - 30) + "deg)"
        );
      }),
        this._use_css_animation
          ? this._overlay_bg.css(
              "background-color",
              this._background[this._loaded % this._background.length]
            )
  ...
  _imageOnLoad: function (a, b) {
    this._image_queue.push({ name: a, image_src: b }),
      this._image_queue.length &&
        this._image_queue[0].image_src === b &&
        this._processQueue();
  },
  _reQueue: function () {
  ...
  config: function (a) {
    "undefined" != typeof a.mode && (this._mode = a.mode),
      ...
      "undefined" != typeof a.showPercentage &&
        (this._show_percentage = !!a.showPercentage),
      "undefined" != typeof a.showInfo && (this._show_info = !!a.showInfo),
...
$(document).ready(Royal_Preloader._init),
  (function (a) {
    a(window).on("load", function () {
      a(".sidebar-nav").mCustomScrollbar({
        autoHideScrollbar: !0,
        theme: "sm-line",
      });
    });
  ...
  (function () {
    ...
    $(".main-nav>ul li").on("mouseenter", function () {
      ...
      $(".cart-button a").on("click", function () {
        return $(this).find("+ .top_cart_list_product").fadeToggle(), !1;
      });
    var a = $(window).height(),
      b = $("header").height(),
      c = $("footer").height(),
    ...
    $(window).on("scroll", function () {
      $(this).scrollTop() > e
        ? $("#to-the-top").fadeIn(f)
        : $("#to-the-top").fadeOut(f);
    }),
      $("#to-the-top").on("click", function (a) {
        return (
          a.preventDefault(), $("html, body").animate({ scrollTop: 0 }, f), !1
        );
      }),
      $(window).on("scroll", function () {
        $(this).scrollTop() > 0
